...
#define WXWIN_OS_DESCRIPTION "Darwin 10.8.0 x86_64"

/* the installation location prefix from configure */
#define wxINSTALL_PREFIX "/Applications/Maxima.app/Contents/Resources/opt/Library/Frameworks/wxWidgets.framework/Versions/wxWidgets/3.0"
