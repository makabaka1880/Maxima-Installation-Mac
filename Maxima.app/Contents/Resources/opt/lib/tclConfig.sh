...
# installed.
TCL_PREFIX='/Applications/Maxima.app/Contents/Resources/opt'

# Top-level directory in which Tcl's platform-specific files (e.g.
# executables) are installed.
TCL_EXEC_PREFIX='/Applications/Maxima.app/Contents/Resources/opt'
...
TCL_LD_FLAGS='-Wl,-headerpad_max_install_names  -headerpad_max_install_names -Wl,-search_paths_first '
...
# build directory.
TCL_BUILD_LIB_SPEC='-L/Applications/Maxima.app/Contents/Resources/opt/var/macports/build/_Applications_Maxima.app_Contents_Resources_opt_var_macports_sources_rsync.macports.org_macports_release_tarballs_ports_lang_tcl/tcl/work/tcl8.6.7/unix -ltcl8.6'

# String to pass to linker to pick up the Tcl library from its
# installed directory.
TCL_LIB_SPEC='-L/Applications/Maxima.app/Contents/Resources/opt/lib -ltcl8.6'

# String to pass to the compiler so that an extension can
# find installed Tcl headers.
TCL_INCLUDE_SPEC='-I/Applications/Maxima.app/Contents/Resources/opt/include'
...
# compiled.
TCL_SRC_DIR='/Applications/Maxima.app/Contents/Resources/opt/var/macports/build/_Applications_Maxima.app_Contents_Resources_opt_var_macports_sources_rsync.macports.org_macports_release_tarballs_ports_lang_tcl/tcl/work/tcl8.6.7'

# List of standard directories in which to look for packages during
# "package require" commands.  Contains the "prefix" directory plus also
# the "exec_prefix" directory, if it is different.
TCL_PACKAGE_PATH='/Applications/Maxima.app/Contents/Resources/opt/lib '
...
# build directory.
TCL_BUILD_STUB_LIB_SPEC='-L/Applications/Maxima.app/Contents/Resources/opt/var/macports/build/_Applications_Maxima.app_Contents_Resources_opt_var_macports_sources_rsync.macports.org_macports_release_tarballs_ports_lang_tcl/tcl/work/tcl8.6.7/unix -ltclstub8.6'

# String to pass to linker to pick up the Tcl stub library from its
# installed directory.
TCL_STUB_LIB_SPEC='-L/Applications/Maxima.app/Contents/Resources/opt/lib -ltclstub8.6'

# Path to the Tcl stub library in the build directory.
TCL_BUILD_STUB_LIB_PATH='/Applications/Maxima.app/Contents/Resources/opt/var/macports/build/_Applications_Maxima.app_Contents_Resources_opt_var_macports_sources_rsync.macports.org_macports_release_tarballs_ports_lang_tcl/tcl/work/tcl8.6.7/unix/libtclstub8.6.a'

# Path to the Tcl stub library in the install directory.
TCL_STUB_LIB_PATH='/Applications/Maxima.app/Contents/Resources/opt/lib/libtclstub8.6.a'
